      ...
      >
            ...
            <div className="mx-auto  w-8/12 md:w-10/12 mb-5 xl:w-11/12 ">
              ...
              <div className="text-center  xl:pl-32 xl:justify-self-end xl:text-left">
                <div className="text-lime-500 font-semibold pb-8">
                  <span>
                    <AttachMoneyIcon className=" -translate-y-4 translate-x-1 md:-translate-y-5 xl:translate-y-5 xl:-translate-x-5 xl:scale-125" />
                  </span>
        ...
        <div className="text-center shadow pb-12 md:grid md:w-11/12  md:shadow-none md:grid-cols-3 md:ml-3 gap-1 lg:-my-7 ">
          <div className="">
            ...
            <AttachMoneyIcon className="inline scale-75 -translate-y-3 translate-x-1 xl:font-extrabold" />
            <div className="font-bold text-3xl inline md:text-xl xl:text-2xl xl:font-extrabold">4,000</div>
          ...
          <div>
            ...
            <AttachMoneyIcon className="inline scale-75 -translate-y-3 translate-x-1 xl:font-extrabold" />
            <div className="font-bold text-3xl inline md:text-xl xl:text-2xl xl:font-extrabold">846,000</div>
            <div className="text-2xl md:text-lg md:font-medium">
              4% of Total
            </div>
          </div>
      ...
      <div className="w-9/12 mx-auto pb-10 ">
        ...
        <div className="pb-5 ">
          ...
          <div className="text-lime-500 font-semibold ">
            <AttachMoneyIcon className="inline scale-75 -translate-y-3 translate-x-1 xl:scale-100" />
            <span className="font-bold text-2xl inline md:text-2xl xl:font-extrabold">44,801</span>
          </div>
        ...
        <div className="pb-5">
          ...
          <div className="text-lime-500 font-semibold ">
            <AttachMoneyIcon className="inline scale-75 -translate-y-3 translate-x-3 xl:scale-100" />
            <span className="font-bold text-2xl inline md:text-2xl xl:font-extrabold"> 57,345</span>
          </div>
          <p className="font-medium">in additional growth</p>
        </div>
        <div>
          ...
          <div className="text-lime-500 font-semibold ">
            <AttachMoneyIcon className="inline scale-75 -translate-y-3 translate-x-3 xl:scale-100" />
            <span className="font-bold text-2xl inline xl:font-extrabold"> 89,603</span>
          </div>
          <p className="font-medium">in additional growth</p>
        </div>
        </div>
